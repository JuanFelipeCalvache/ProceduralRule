...
def get_residencial_cga(height, floors_level, windows_per_level):
    return f"""version "2020.0"
...
attr lotHeight = {height}

#BuildInf
attr floorsLevel = {floors_level}
attr floorMeasure = lotHeight/floorsLevel - 1
attr floorPerLevel = {windows_per_level}
...
def get_comercial_cga(height, floors_level, windows_per_level):
    return f"""version "2020.0"
...
def get_industrial_cga(height, modules):
    return f"""version "2020.0"
...
def get_balcony_cga(floor_levels, floors_build):
    return f"""version "2020.0"
...
def get_window_cga(floor_levels, floors_build):
    return f"""version "2020.0"
